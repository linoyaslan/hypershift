...
func bindCoreOptions(opts *RawCreateOptions, flags *pflag.FlagSet) {
	...
	flags.StringSliceVar(&opts.DisableClusterCapabilities, "disable-cluster-capabilities", nil, "Optional cluster capabilities to disabled. The only currently supported values are ImageRegistry,Console, Build")
...
func (opts *RawCreateOptions) Validate(ctx context.Context) (*ValidatedCreateOptions, error) {
	...
	if len(opts.DisableClusterCapabilities) > 0 {
		acceptedValues := sets.NewString("ImageRegistry", "Console", "Build")
