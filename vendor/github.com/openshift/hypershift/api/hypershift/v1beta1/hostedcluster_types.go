...
// +kubebuilder:validation:Enum=ImageRegistry;openshift-samples;Insights;baremetal;Console;Ingress;NodeTuning
...
type Capabilities struct {
	...
	// Once set, this field cannot be changed.
	//
	// Note: Disabling 'openshift-samples','Insights', 'Console', 'Ingress', 'NodeTuning' are only supported in OpenShift versions 4.20 and above.
	//
	// +listType=atomic
	// +immutable
	// +optional
