		...
		Spec: hyperv1.HostedControlPlaneSpec{
			...
			Capabilities: &hyperv1.Capabilities{
				Disabled: []hyperv1.OptionalCapability{
					hyperv1.ImageRegistryCapability, hyperv1.OpenShiftSamplesCapability, hyperv1.InsightsCapability, hyperv1.ConsoleCapability, hyperv1.IngressCapability, hyperv1.NodeTuningCapability,
				},
			},
		},
	}
