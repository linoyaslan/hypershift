...
Once set, this field cannot be changed.</p>
<p>Note: Disabling &lsquo;openshift-samples&rsquo;,&lsquo;Insights&rsquo;, &lsquo;Console&rsquo;, &lsquo;Ingress&rsquo;, &lsquo;NodeTuning&rsquo; are only supported in OpenShift versions 4.20 and above.</p>
</td>
</tr>
</tbody>
</table>
